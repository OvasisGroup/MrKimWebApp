            ...
            <div class='mainfotter'>
              ...
              <div class='spotstwo'>
                ...
                <ul>
                  ...
                  <li>
                    <a href="{{ route('getapp') }}"><p>Get The App</p></a>
                  </li>
                  <li>
              ...
              <div class='spotsthree'>
                ...
                <ul>
                  ...
                  <li>
                    <a href="{{ route('legal') }}"><p>Legal</p></a>
                  </li>
                  <li>
                    <a href="{{ route('safety') }}"><p>Safety</p></a>
                  </li>
    
                  
                  <li>
                    <a href="{{ route('faq') }}"><p>FAQs</p></a>
                  </li>
                </ul>
              </div>
              <div class='spotsfour'>
                ...
                <ul>
                  <li>
                    <a href="{{ route('help') }}"><p>Help</p></a>
                  </li>
                  
                  <li>
                    <a href="{{ route('contacts') }}"><p>Contact Us</p></a>
                  </li>
                </ul>
              </div>
            </div>
